...
<section class="estilo_general">
	  ...
	  <div id="encabezado"  >
		...
		<h2 id="ej2">Ejemplo Listas</h2>
			...
			<!-- Lista SIN orden -->
			<ul>
				<li>Elmento de lista 1</li>
				<li>Elmento de lista 2</li>
				<li>Elmento de lista 3</li>
			</ul>
			<!-- Lista Definicion -->
